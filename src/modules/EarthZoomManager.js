...
class EarthZoomManager {
    ...
    initLeafletMap() {
        ...
        if (typeof L === 'undefined') {
            console.warn('[EarthZoomManager] Leaflet not loaded yet, deferring initialization');
            return;
        }
    ...
    zoomOutFromMap() {
        ...
        console.log('[EarthZoomManager] Zooming out from map');
    }
    ...
    update(deltaTime) {
        ...
        if (this.controls && !this.controls.enabled && this.transitionProgress < 0.99) {
            console.log('[EarthZoomManager] Safety: Re-enabling stuck controls');
    ...
    updateTransitionUI(surfaceDistance) {
        ...
        if (progress > 0) {
            ...
            if (!this.isMapVisible && progress > 0.5) {
                ...
                console.log(`[EarthZoomManager] Map visible at ${lat.toFixed(2)}°, ${lng.toFixed(2)}°`);
            }
        } else {
            ...
            if (this.isMapVisible) {
                this.isMapVisible = false;
                console.log('[EarthZoomManager] Map hidden');
            }
        }
        ...
        if (this.controls) {
            ...
            if (this.controls.enabled !== shouldBeEnabled) {
                ...
                console.log(`[EarthZoomManager] Controls ${shouldBeEnabled ? 'enabled' : 'disabled'}, progress: ${progress.toFixed(2)}`);
            }
        }
    ...
    showMap(lat = 0, lng = 0, zoom = 5) {
        if (!this.map) {
            this.initLeafletMap();
            if (!this.map) {
                console.error('[EarthZoomManager] Cannot show map - Leaflet not initialized');
                return;
            }
        }
        ...
        console.log(`[EarthZoomManager] Showing map at ${lat.toFixed(2)}°, ${lng.toFixed(2)}°`);
    }
    ...
    hideMap() {
        ...
        console.log('[EarthZoomManager] Returning to space view');
    }
    ...
    zoomToLocation(point, lat, lng) {
        ...
        console.log(`[EarthZoomManager] Zooming to ${lat.toFixed(2)}°, ${lng.toFixed(2)}°`);
    }

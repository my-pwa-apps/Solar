...
const translations = {
    ...
    fr: {
        ...
        descGPS: 'Constellation GPS (NAVSTAR): 31 satellites opérationnels (oct 2025) sur 6 plans orbitaux, inclinaison 55°. Chaque satellite orbite à 20 180 km d\'altitude. Émet des signaux bande L (1,2-1,5 GHz). Horloges atomiques rubidium/césium précises à 10â»×¹â´ secondes.',
    ...
    de: {
        ...
        descGPS: 'GPS-Konstellation (NAVSTAR): 31 operative Satelliten (Okt 2025) in 6 Bahnebenen, 55° Neigung. Jeder Satellit umkreist in 20.180 km Höhe. Sendet L-Band-Signale (1,2-1,5 GHz). Rubidium/Cäsium-Atomuhren genau auf 10â»×¹â´ Sekunden.',
    ...
    es: {
        ...
        descGPS: 'Constelación GPS (NAVSTAR): 31 satélites operativos (oct 2025) en 6 planos orbitales, inclinación 55°. Cada satélite orbita a 20.180 km de altitud. Transmite señales banda L (1,2-1,5 GHz). Relojes atómicos de rubidio/cesio precisos a 10â»×¹â´ segundos.',
    ...
    pt: {
        ...
        descGPS: 'Constelação GPS (NAVSTAR): 31 satélites operacionais (out 2025) em 6 planos orbitais, inclinação 55°. Cada satélite orbita a 20.180 km de altitude. Transmite sinais banda L (1,2-1,5 GHz). Relógios atÃ´micos de rubídio/césio precisos a 10â»×¹â´ segundos.',
